...
const PredictRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'inputs', '3': 2, '4': 3, '5': 11, '6': '.tensorflow.serving.PredictRequest.InputsEntry', '10': 'inputs'},
...
const PredictRequest_InputsEntry$json = const {
  ...
  '2': const [
    ...
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.tensorflow.TensorProto', '10': 'value'},
  ],
  '7': const {'7': true},
};

/// Descriptor for `PredictRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List predictRequestDescriptor = $convert.base64Decode('');
...
const PredictResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'outputs', '3': 1, '4': 3, '5': 11, '6': '.tensorflow.serving.PredictResponse.OutputsEntry', '10': 'outputs'},
  ],
