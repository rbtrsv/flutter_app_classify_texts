...
class ModelSpec extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, ModelSpec_VersionChoice> _ModelSpec_VersionChoiceByTag = {
    2 : ModelSpec_VersionChoice.version,
    4 : ModelSpec_VersionChoice.versionLabel,
    0 : ModelSpec_VersionChoice.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow.serving'), createEmptyInstance: create)
    ..oo(0, [2, 4])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$0.Int64Value>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version', subBuilder: $0.Int64Value.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signatureName')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionLabel')
  ...
  'Will be removed in next major version')
  ModelSpec copyWith(void Function(ModelSpec) updates) => super.copyWith((message) => updates(message as ModelSpec)) as ModelSpec; // ignore: deprecated_member_use
  ...
  ModelSpec_VersionChoice whichVersionChoice() => _ModelSpec_VersionChoiceByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(2)
  set version($0.Int64Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set signatureName($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set versionLabel($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
