...
class Regression extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Regression', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow.serving'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  Regression copyWith(void Function(Regression) updates) => super.copyWith((message) => updates(message as Regression)) as Regression; // ignore: deprecated_member_use
...
class RegressionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RegressionResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow.serving'), createEmptyInstance: create)
    ..pc<Regression>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'regressions', $pb.PbFieldType.PM, subBuilder: Regression.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RegressionResult copyWith(void Function(RegressionResult) updates) => super.copyWith((message) => updates(message as RegressionResult)) as RegressionResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RegressionRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RegressionRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow.serving'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RegressionRequest copyWith(void Function(RegressionRequest) updates) => super.copyWith((message) => updates(message as RegressionRequest)) as RegressionRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RegressionResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RegressionResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow.serving'), createEmptyInstance: create)
    ..aOM<RegressionResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'result', subBuilder: RegressionResult.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RegressionResponse copyWith(void Function(RegressionResponse) updates) => super.copyWith((message) => updates(message as RegressionResponse)) as RegressionResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set result(RegressionResult v) { setField(1, v); }
  @$pb.TagNumber(1)
