...
class TensorShapeProto_Dim extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TensorShapeProto.Dim', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  TensorShapeProto_Dim copyWith(void Function(TensorShapeProto_Dim) updates) => super.copyWith((message) => updates(message as TensorShapeProto_Dim)) as TensorShapeProto_Dim; // ignore: deprecated_member_use
...
class TensorShapeProto extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TensorShapeProto', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..pc<TensorShapeProto_Dim>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dim', $pb.PbFieldType.PM, subBuilder: TensorShapeProto_Dim.create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unknownRank')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TensorShapeProto copyWith(void Function(TensorShapeProto) updates) => super.copyWith((message) => updates(message as TensorShapeProto)) as TensorShapeProto; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
