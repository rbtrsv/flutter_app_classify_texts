...
class VersionDef extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VersionDef', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'producer', $pb.PbFieldType.O3)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minConsumer', $pb.PbFieldType.O3)
    ..p<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'badConsumers', $pb.PbFieldType.K3)
  ...
  'Will be removed in next major version')
  VersionDef copyWith(void Function(VersionDef) updates) => super.copyWith((message) => updates(message as VersionDef)) as VersionDef; // ignore: deprecated_member_use
