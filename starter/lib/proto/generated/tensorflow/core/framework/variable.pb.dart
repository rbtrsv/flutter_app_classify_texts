...
class VariableDef extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VariableDef', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'variableName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'initializerName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'snapshotName')
    ..aOM<SaveSliceInfoDef>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'saveSliceInfoDef', subBuilder: SaveSliceInfoDef.create)
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isResource')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'initialValueName')
    ..aOB(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainable')
    ..e<VariableSynchronization>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'synchronization', $pb.PbFieldType.OE, defaultOrMaker: VariableSynchronization.VARIABLE_SYNCHRONIZATION_AUTO, valueOf: VariableSynchronization.valueOf, enumValues: VariableSynchronization.values)
    ..e<VariableAggregation>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'aggregation', $pb.PbFieldType.OE, defaultOrMaker: VariableAggregation.VARIABLE_AGGREGATION_NONE, valueOf: VariableAggregation.valueOf, enumValues: VariableAggregation.values)
  ...
  'Will be removed in next major version')
  VariableDef copyWith(void Function(VariableDef) updates) => super.copyWith((message) => updates(message as VariableDef)) as VariableDef; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set saveSliceInfoDef(SaveSliceInfoDef v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(8)
  set synchronization(VariableSynchronization v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set aggregation(VariableAggregation v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class SaveSliceInfoDef extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SaveSliceInfoDef', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fullName')
    ..p<$fixnum.Int64>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fullShape', $pb.PbFieldType.K6)
    ..p<$fixnum.Int64>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'varOffset', $pb.PbFieldType.K6)
    ..p<$fixnum.Int64>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'varShape', $pb.PbFieldType.K6)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SaveSliceInfoDef copyWith(void Function(SaveSliceInfoDef) updates) => super.copyWith((message) => updates(message as SaveSliceInfoDef)) as SaveSliceInfoDef; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
