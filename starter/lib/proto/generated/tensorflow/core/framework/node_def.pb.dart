...
class NodeDef_ExperimentalDebugInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NodeDef.ExperimentalDebugInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalNodeNames')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalFuncNames')
  ...
  'Will be removed in next major version')
  NodeDef_ExperimentalDebugInfo copyWith(void Function(NodeDef_ExperimentalDebugInfo) updates) => super.copyWith((message) => updates(message as NodeDef_ExperimentalDebugInfo)) as NodeDef_ExperimentalDebugInfo; // ignore: deprecated_member_use
...
class NodeDef extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NodeDef', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'op')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'input')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'device')
    ..m<$core.String, $1.AttrValue>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attr', entryClassName: 'NodeDef.AttrEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1.AttrValue.create, packageName: const $pb.PackageName('tensorflow'))
    ..aOM<NodeDef_ExperimentalDebugInfo>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'experimentalDebugInfo', subBuilder: NodeDef_ExperimentalDebugInfo.create)
    ..aOM<$0.FullTypeDef>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'experimentalType', subBuilder: $0.FullTypeDef.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NodeDef copyWith(void Function(NodeDef) updates) => super.copyWith((message) => updates(message as NodeDef)) as NodeDef; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(6)
  set experimentalDebugInfo(NodeDef_ExperimentalDebugInfo v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set experimentalType($0.FullTypeDef v) { setField(7, v); }
  @$pb.TagNumber(7)
