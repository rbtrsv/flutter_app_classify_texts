...
class FunctionDefLibrary extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FunctionDefLibrary', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..pc<FunctionDef>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'function', $pb.PbFieldType.PM, subBuilder: FunctionDef.create)
    ..pc<GradientDef>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gradient', $pb.PbFieldType.PM, subBuilder: GradientDef.create)
    ..pc<RegisteredGradient>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'registeredGradients', $pb.PbFieldType.PM, subBuilder: RegisteredGradient.create)
  ...
  'Will be removed in next major version')
  FunctionDefLibrary copyWith(void Function(FunctionDefLibrary) updates) => super.copyWith((message) => updates(message as FunctionDefLibrary)) as FunctionDefLibrary; // ignore: deprecated_member_use
...
class FunctionDef_ArgAttrs extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FunctionDef.ArgAttrs', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..m<$core.String, $2.AttrValue>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attr', entryClassName: 'FunctionDef.ArgAttrs.AttrEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $2.AttrValue.create, packageName: const $pb.PackageName('tensorflow'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FunctionDef_ArgAttrs copyWith(void Function(FunctionDef_ArgAttrs) updates) => super.copyWith((message) => updates(message as FunctionDef_ArgAttrs)) as FunctionDef_ArgAttrs; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FunctionDef extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FunctionDef', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..aOM<$0.OpDef>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signature', subBuilder: $0.OpDef.create)
    ..pc<$1.NodeDef>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nodeDef', $pb.PbFieldType.PM, subBuilder: $1.NodeDef.create)
    ..m<$core.String, $core.String>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ret', entryClassName: 'FunctionDef.RetEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('tensorflow'))
    ..m<$core.String, $2.AttrValue>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attr', entryClassName: 'FunctionDef.AttrEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $2.AttrValue.create, packageName: const $pb.PackageName('tensorflow'))
    ..m<$core.String, $core.String>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'controlRet', entryClassName: 'FunctionDef.ControlRetEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('tensorflow'))
    ..m<$core.int, FunctionDef_ArgAttrs>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'argAttr', entryClassName: 'FunctionDef.ArgAttrEntry', keyFieldType: $pb.PbFieldType.OU3, valueFieldType: $pb.PbFieldType.OM, valueCreator: FunctionDef_ArgAttrs.create, packageName: const $pb.PackageName('tensorflow'))
    ..m<$core.int, $core.int>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceArgUniqueId', entryClassName: 'FunctionDef.ResourceArgUniqueIdEntry', keyFieldType: $pb.PbFieldType.OU3, valueFieldType: $pb.PbFieldType.OU3, packageName: const $pb.PackageName('tensorflow'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FunctionDef copyWith(void Function(FunctionDef) updates) => super.copyWith((message) => updates(message as FunctionDef)) as FunctionDef; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set signature($0.OpDef v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class GradientDef extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GradientDef', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'functionName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gradientFunc')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GradientDef copyWith(void Function(GradientDef) updates) => super.copyWith((message) => updates(message as GradientDef)) as GradientDef; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RegisteredGradient extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RegisteredGradient', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gradientFunc')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'registeredOpType')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RegisteredGradient copyWith(void Function(RegisteredGradient) updates) => super.copyWith((message) => updates(message as RegisteredGradient)) as RegisteredGradient; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
