...
class SavedObjectGraph extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SavedObjectGraph', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..pc<SavedObject>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nodes', $pb.PbFieldType.PM, subBuilder: SavedObject.create)
    ..m<$core.String, SavedConcreteFunction>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'concreteFunctions', entryClassName: 'SavedObjectGraph.ConcreteFunctionsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: SavedConcreteFunction.create, packageName: const $pb.PackageName('tensorflow'))
  ...
  'Will be removed in next major version')
  SavedObjectGraph copyWith(void Function(SavedObjectGraph) updates) => super.copyWith((message) => updates(message as SavedObjectGraph)) as SavedObjectGraph; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  $core.Map<$core.String, SavedConcreteFunction> get concreteFunctions => $_getMap(1);
}
...
class SavedObject extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SavedObject', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..oo(0, [4, 5, 6, 7, 8, 9, 10, 12])
    ..pc<$0.TrackableObjectGraph_TrackableObject_ObjectReference>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'children', $pb.PbFieldType.PM, subBuilder: $0.TrackableObjectGraph_TrackableObject_ObjectReference.create)
    ..pc<$0.TrackableObjectGraph_TrackableObject_SlotVariableReference>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'slotVariables', $pb.PbFieldType.PM, subBuilder: $0.TrackableObjectGraph_TrackableObject_SlotVariableReference.create)
    ..aOM<SavedUserObject>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userObject', subBuilder: SavedUserObject.create)
    ..aOM<SavedAsset>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'asset', subBuilder: SavedAsset.create)
    ..aOM<SavedFunction>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'function', subBuilder: SavedFunction.create)
    ..aOM<SavedVariable>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'variable', subBuilder: SavedVariable.create)
    ..aOM<SavedBareConcreteFunction>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bareConcreteFunction', subBuilder: SavedBareConcreteFunction.create)
    ..aOM<SavedConstant>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'constant', subBuilder: SavedConstant.create)
    ..aOM<SavedResource>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resource', subBuilder: SavedResource.create)
    ..m<$core.String, SaveableObject>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'saveableObjects', entryClassName: 'SavedObject.SaveableObjectsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: SaveableObject.create, packageName: const $pb.PackageName('tensorflow'))
    ..aOM<CapturedTensor>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'capturedTensor', subBuilder: CapturedTensor.create)
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'registeredName')
    ..aOM<$1.Any>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serializedUserProto', subBuilder: $1.Any.create)
    ..pc<$0.TrackableObjectGraph_TrackableObject_ObjectReference>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dependencies', $pb.PbFieldType.PM, subBuilder: $0.TrackableObjectGraph_TrackableObject_ObjectReference.create)
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'registeredSaver')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SavedObject copyWith(void Function(SavedObject) updates) => super.copyWith((message) => updates(message as SavedObject)) as SavedObject; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $core.List<$0.TrackableObjectGraph_TrackableObject_ObjectReference> get children => $_getList(0);

  @$pb.TagNumber(3)
  $core.List<$0.TrackableObjectGraph_TrackableObject_SlotVariableReference> get slotVariables => $_getList(1);

  @$pb.TagNumber(4)
  SavedUserObject get userObject => $_getN(2);
  @$pb.TagNumber(4)
  set userObject(SavedUserObject v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set asset(SavedAsset v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set function(SavedFunction v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set variable(SavedVariable v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set bareConcreteFunction(SavedBareConcreteFunction v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set constant(SavedConstant v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set resource(SavedResource v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  set capturedTensor(CapturedTensor v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(14)
  set serializedUserProto($1.Any v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  $core.List<$0.TrackableObjectGraph_TrackableObject_ObjectReference> get dependencies => $_getList(13);
...
class SavedUserObject extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SavedUserObject', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'identifier')
    ..aOM<$2.VersionDef>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version', subBuilder: $2.VersionDef.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SavedUserObject copyWith(void Function(SavedUserObject) updates) => super.copyWith((message) => updates(message as SavedUserObject)) as SavedUserObject; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set version($2.VersionDef v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class SavedAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SavedAsset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetFileDefIndex', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SavedAsset copyWith(void Function(SavedAsset) updates) => super.copyWith((message) => updates(message as SavedAsset)) as SavedAsset; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SavedFunction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SavedFunction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'concreteFunctions')
    ..aOM<FunctionSpec>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'functionSpec', subBuilder: FunctionSpec.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SavedFunction copyWith(void Function(SavedFunction) updates) => super.copyWith((message) => updates(message as SavedFunction)) as SavedFunction; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set functionSpec(FunctionSpec v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class CapturedTensor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CapturedTensor', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'concreteFunction')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CapturedTensor copyWith(void Function(CapturedTensor) updates) => super.copyWith((message) => updates(message as CapturedTensor)) as CapturedTensor; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SavedConcreteFunction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SavedConcreteFunction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..p<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boundInputs', $pb.PbFieldType.K3)
    ..aOM<$3.StructuredValue>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'canonicalizedInputSignature', subBuilder: $3.StructuredValue.create)
    ..aOM<$3.StructuredValue>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputSignature', subBuilder: $3.StructuredValue.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SavedConcreteFunction copyWith(void Function(SavedConcreteFunction) updates) => super.copyWith((message) => updates(message as SavedConcreteFunction)) as SavedConcreteFunction; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set canonicalizedInputSignature($3.StructuredValue v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set outputSignature($3.StructuredValue v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class SavedBareConcreteFunction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SavedBareConcreteFunction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'concreteFunctionName')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'argumentKeywords')
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedPositionalArguments')
    ..aOM<FunctionSpec>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'functionSpec', subBuilder: FunctionSpec.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SavedBareConcreteFunction copyWith(void Function(SavedBareConcreteFunction) updates) => super.copyWith((message) => updates(message as SavedBareConcreteFunction)) as SavedBareConcreteFunction; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set functionSpec(FunctionSpec v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class SavedConstant extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SavedConstant', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SavedConstant copyWith(void Function(SavedConstant) updates) => super.copyWith((message) => updates(message as SavedConstant)) as SavedConstant; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SavedVariable extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SavedVariable', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..e<$5.DataType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dtype', $pb.PbFieldType.OE, defaultOrMaker: $5.DataType.DT_INVALID, valueOf: $5.DataType.valueOf, enumValues: $5.DataType.values)
    ..aOM<$4.TensorShapeProto>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shape', subBuilder: $4.TensorShapeProto.create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainable')
    ..e<$6.VariableSynchronization>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'synchronization', $pb.PbFieldType.OE, defaultOrMaker: $6.VariableSynchronization.VARIABLE_SYNCHRONIZATION_AUTO, valueOf: $6.VariableSynchronization.valueOf, enumValues: $6.VariableSynchronization.values)
    ..e<$6.VariableAggregation>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'aggregation', $pb.PbFieldType.OE, defaultOrMaker: $6.VariableAggregation.VARIABLE_AGGREGATION_NONE, valueOf: $6.VariableAggregation.valueOf, enumValues: $6.VariableAggregation.values)
    ...
    ..pc<SavedVariable>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'experimentalDistributedVariableComponents', $pb.PbFieldType.PM, subBuilder: SavedVariable.create)
    ..hasRequiredFields = false
  ;
  ...
  factory SavedVariable({
    ...
    if (experimentalDistributedVariableComponents != null) {
      _result.experimentalDistributedVariableComponents.addAll(experimentalDistributedVariableComponents);
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SavedVariable copyWith(void Function(SavedVariable) updates) => super.copyWith((message) => updates(message as SavedVariable)) as SavedVariable; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set dtype($5.DataType v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set shape($4.TensorShapeProto v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  set synchronization($6.VariableSynchronization v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set aggregation($6.VariableAggregation v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(8)
  $core.List<SavedVariable> get experimentalDistributedVariableComponents => $_getList(7);
}

class FunctionSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FunctionSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..aOM<$3.StructuredValue>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fullargspec', subBuilder: $3.StructuredValue.create)
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isMethod')
    ..aOM<$3.StructuredValue>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputSignature', subBuilder: $3.StructuredValue.create)
    ..e<FunctionSpec_JitCompile>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jitCompile', $pb.PbFieldType.OE, defaultOrMaker: FunctionSpec_JitCompile.DEFAULT, valueOf: FunctionSpec_JitCompile.valueOf, enumValues: FunctionSpec_JitCompile.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FunctionSpec copyWith(void Function(FunctionSpec) updates) => super.copyWith((message) => updates(message as FunctionSpec)) as FunctionSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set fullargspec($3.StructuredValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(5)
  set inputSignature($3.StructuredValue v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set jitCompile(FunctionSpec_JitCompile v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class SavedResource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SavedResource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SavedResource copyWith(void Function(SavedResource) updates) => super.copyWith((message) => updates(message as SavedResource)) as SavedResource; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SaveableObject extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SaveableObject', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'saveFunction', $pb.PbFieldType.O3)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'restoreFunction', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SaveableObject copyWith(void Function(SaveableObject) updates) => super.copyWith((message) => updates(message as SaveableObject)) as SaveableObject; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
