...
const MetaGraphDef$json = const {
  ...
  '2': const [
    ...
    const {'1': 'object_graph_def', '3': 7, '4': 1, '5': 11, '6': '.tensorflow.SavedObjectGraph', '10': 'objectGraphDef'},
  ],
...
const MetaGraphDef_MetaInfoDef$json = const {
  ...
  '2': const [
    ...
    const {'1': 'function_aliases', '3': 8, '4': 3, '5': 11, '6': '.tensorflow.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry', '10': 'functionAliases'},
  ],
...
final $typed_data.Uint8List collectionDefDescriptor = $convert.base64Decode('');
...
const TensorInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'composite_tensor', '3': 5, '4': 1, '5': 11, '6': '.tensorflow.TensorInfo.CompositeTensor', '9': 0, '10': 'compositeTensor'},
...
const TensorInfo_CompositeTensor$json = const {
  '1': 'CompositeTensor',
  '2': const [
    const {'1': 'type_spec', '3': 1, '4': 1, '5': 11, '6': '.tensorflow.TypeSpecProto', '10': 'typeSpec'},
    const {'1': 'components', '3': 2, '4': 3, '5': 11, '6': '.tensorflow.TensorInfo', '10': 'components'},
  ],
};

/// Descriptor for `TensorInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List tensorInfoDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List assetFileDefDescriptor = $convert.base64Decode('CgxBc3NldEZpbGVEZWYSNwoLdGVuc29yX2luZm8YASABKAsyFi50ZW5zb3JmbG93LlRlbnNvckluZm9SCnRlbnNvckluZm8SGgoIZmlsZW5hbWUYAiABKAlSCGZpbGVuYW1l');
