...
class MetaGraphDef_MetaInfoDef extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MetaGraphDef.MetaInfoDef', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metaGraphVersion')
    ..aOM<$3.OpList>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'strippedOpList', subBuilder: $3.OpList.create)
    ..aOM<$4.Any>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'anyInfo', subBuilder: $4.Any.create)
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tags')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tensorflowVersion')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tensorflowGitVersion')
    ..aOB(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'strippedDefaultAttrs')
    ..m<$core.String, $core.String>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'functionAliases', entryClassName: 'MetaGraphDef.MetaInfoDef.FunctionAliasesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('tensorflow'))
  ...
  'Will be removed in next major version')
  MetaGraphDef_MetaInfoDef copyWith(void Function(MetaGraphDef_MetaInfoDef) updates) => super.copyWith((message) => updates(message as MetaGraphDef_MetaInfoDef)) as MetaGraphDef_MetaInfoDef; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set strippedOpList($3.OpList v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set anyInfo($4.Any v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class MetaGraphDef extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MetaGraphDef', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..aOM<MetaGraphDef_MetaInfoDef>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metaInfoDef', subBuilder: MetaGraphDef_MetaInfoDef.create)
    ..aOM<$0.GraphDef>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'graphDef', subBuilder: $0.GraphDef.create)
    ..aOM<$1.SaverDef>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'saverDef', subBuilder: $1.SaverDef.create)
    ..m<$core.String, CollectionDef>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'collectionDef', entryClassName: 'MetaGraphDef.CollectionDefEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: CollectionDef.create, packageName: const $pb.PackageName('tensorflow'))
    ..m<$core.String, SignatureDef>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signatureDef', entryClassName: 'MetaGraphDef.SignatureDefEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: SignatureDef.create, packageName: const $pb.PackageName('tensorflow'))
    ..pc<AssetFileDef>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetFileDef', $pb.PbFieldType.PM, subBuilder: AssetFileDef.create)
    ..aOM<$2.SavedObjectGraph>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'objectGraphDef', subBuilder: $2.SavedObjectGraph.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MetaGraphDef copyWith(void Function(MetaGraphDef) updates) => super.copyWith((message) => updates(message as MetaGraphDef)) as MetaGraphDef; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set metaInfoDef(MetaGraphDef_MetaInfoDef v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set graphDef($0.GraphDef v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set saverDef($1.SaverDef v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(7)
  set objectGraphDef($2.SavedObjectGraph v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class CollectionDef_NodeList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CollectionDef.NodeList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CollectionDef_NodeList copyWith(void Function(CollectionDef_NodeList) updates) => super.copyWith((message) => updates(message as CollectionDef_NodeList)) as CollectionDef_NodeList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CollectionDef_BytesList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CollectionDef.BytesList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..p<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', $pb.PbFieldType.PY)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CollectionDef_BytesList copyWith(void Function(CollectionDef_BytesList) updates) => super.copyWith((message) => updates(message as CollectionDef_BytesList)) as CollectionDef_BytesList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CollectionDef_Int64List extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CollectionDef.Int64List', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..p<$fixnum.Int64>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', $pb.PbFieldType.K6)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CollectionDef_Int64List copyWith(void Function(CollectionDef_Int64List) updates) => super.copyWith((message) => updates(message as CollectionDef_Int64List)) as CollectionDef_Int64List; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CollectionDef_FloatList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CollectionDef.FloatList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..p<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', $pb.PbFieldType.KF)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CollectionDef_FloatList copyWith(void Function(CollectionDef_FloatList) updates) => super.copyWith((message) => updates(message as CollectionDef_FloatList)) as CollectionDef_FloatList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CollectionDef_AnyList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CollectionDef.AnyList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..pc<$4.Any>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', $pb.PbFieldType.PM, subBuilder: $4.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CollectionDef_AnyList copyWith(void Function(CollectionDef_AnyList) updates) => super.copyWith((message) => updates(message as CollectionDef_AnyList)) as CollectionDef_AnyList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CollectionDef extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CollectionDef', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5])
    ..aOM<CollectionDef_NodeList>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nodeList', subBuilder: CollectionDef_NodeList.create)
    ..aOM<CollectionDef_BytesList>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bytesList', subBuilder: CollectionDef_BytesList.create)
    ..aOM<CollectionDef_Int64List>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'int64List', subBuilder: CollectionDef_Int64List.create)
    ..aOM<CollectionDef_FloatList>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'floatList', subBuilder: CollectionDef_FloatList.create)
    ..aOM<CollectionDef_AnyList>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'anyList', subBuilder: CollectionDef_AnyList.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CollectionDef copyWith(void Function(CollectionDef) updates) => super.copyWith((message) => updates(message as CollectionDef)) as CollectionDef; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set nodeList(CollectionDef_NodeList v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set bytesList(CollectionDef_BytesList v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set int64List(CollectionDef_Int64List v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set floatList(CollectionDef_FloatList v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set anyList(CollectionDef_AnyList v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class TensorInfo_CooSparse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TensorInfo.CooSparse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'valuesTensorName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'indicesTensorName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'denseShapeTensorName')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TensorInfo_CooSparse copyWith(void Function(TensorInfo_CooSparse) updates) => super.copyWith((message) => updates(message as TensorInfo_CooSparse)) as TensorInfo_CooSparse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TensorInfo_CompositeTensor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TensorInfo.CompositeTensor', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..aOM<$6.TypeSpecProto>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'typeSpec', subBuilder: $6.TypeSpecProto.create)
    ..pc<TensorInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'components', $pb.PbFieldType.PM, subBuilder: TensorInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TensorInfo_CompositeTensor copyWith(void Function(TensorInfo_CompositeTensor) updates) => super.copyWith((message) => updates(message as TensorInfo_CompositeTensor)) as TensorInfo_CompositeTensor; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set typeSpec($6.TypeSpecProto v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class TensorInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TensorInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..oo(0, [1, 4, 5])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<$7.DataType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dtype', $pb.PbFieldType.OE, defaultOrMaker: $7.DataType.DT_INVALID, valueOf: $7.DataType.valueOf, enumValues: $7.DataType.values)
    ..aOM<$5.TensorShapeProto>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tensorShape', subBuilder: $5.TensorShapeProto.create)
    ..aOM<TensorInfo_CooSparse>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cooSparse', subBuilder: TensorInfo_CooSparse.create)
    ..aOM<TensorInfo_CompositeTensor>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'compositeTensor', subBuilder: TensorInfo_CompositeTensor.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set dtype($7.DataType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set tensorShape($5.TensorShapeProto v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set cooSparse(TensorInfo_CooSparse v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set compositeTensor(TensorInfo_CompositeTensor v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class SignatureDef extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SignatureDef', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..m<$core.String, TensorInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputs', entryClassName: 'SignatureDef.InputsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: TensorInfo.create, packageName: const $pb.PackageName('tensorflow'))
    ..m<$core.String, TensorInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputs', entryClassName: 'SignatureDef.OutputsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: TensorInfo.create, packageName: const $pb.PackageName('tensorflow'))
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SignatureDef copyWith(void Function(SignatureDef) updates) => super.copyWith((message) => updates(message as SignatureDef)) as SignatureDef; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AssetFileDef extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetFileDef', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..aOM<TensorInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tensorInfo', subBuilder: TensorInfo.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AssetFileDef copyWith(void Function(AssetFileDef) updates) => super.copyWith((message) => updates(message as AssetFileDef)) as AssetFileDef; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set tensorInfo(TensorInfo v) { setField(1, v); }
  @$pb.TagNumber(1)
