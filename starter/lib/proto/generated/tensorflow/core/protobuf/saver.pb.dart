...
class SaverDef extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SaverDef', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tensorflow'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filenameTensorName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'saveTensorName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'restoreOpName')
    ..a<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxToKeep', $pb.PbFieldType.O3)
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sharded')
    ..a<$core.double>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keepCheckpointEveryNHours', $pb.PbFieldType.OF)
    ..e<SaverDef_CheckpointFormatVersion>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version', $pb.PbFieldType.OE, defaultOrMaker: SaverDef_CheckpointFormatVersion.LEGACY, valueOf: SaverDef_CheckpointFormatVersion.valueOf, enumValues: SaverDef_CheckpointFormatVersion.values)
  ...
  'Will be removed in next major version')
  SaverDef copyWith(void Function(SaverDef) updates) => super.copyWith((message) => updates(message as SaverDef)) as SaverDef; // ignore: deprecated_member_use
